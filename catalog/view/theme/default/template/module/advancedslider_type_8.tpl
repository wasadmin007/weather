...
<!------------------------------------- THE CONTENT ------------------------------------------------->
    <div id="wrapper" style="width:<?php echo $slide_size;?>px; height:<?php echo $slide_height;?>px; margin-bottom:30px">
    
         <div id="slider-wrapper" class="slider-wrapper" style="width:<?php echo $slide_size;?>px; height:<?php echo $slide_height;?>px;">
        
            <div id="slider2" class="nivoSlider" style="width:<?php echo $slide_size;?>px; height:<?php echo $slide_height;?>px;">
			
	<?php foreach($ccpos_config as $pos){?>
	
	<a href="<?php echo $pos['urls'];?>"><img src="<?php echo $pos['img'];?>" alt="" <?php if($slide_headline==1){?>title="#htmlcaption_<?php echo $pos['sira'];?>"<?php } ?> style="width:<?php echo $slide_size;?>px; height:<?php echo $slide_height;?>px;"/></a>
