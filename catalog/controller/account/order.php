...
class ControllerAccountOrder extends Controller {
	...
	public function info() { 
		...
		if ($order_info) {
			...
			$products1 = $this->cart->getProducts();

			foreach ($products1 as $product) {
				$product_total = 0;

				foreach ($products1 as $product_2) {
			...
			$this->data['product2'] = array();

			$product2 = $this->cart->getProducts();
			...
			foreach ($products as $product) {
				...
				$image = $this->model_account_order->getImageProducts($product['product_id']);
