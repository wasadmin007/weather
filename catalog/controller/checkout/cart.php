...
class ControllerCheckoutCart extends Controller {
	...
	public function quote() {
		...
		if (!$json) {		
			$this->tax->setShippingAddress($this->request->post['country_id'], $this->request->post['zone_id'], $this->request->post['city_id']);

			// Default Shipping Address
			$this->session->data['shipping_country_id'] = $this->request->post['country_id'];
			$this->session->data['shipping_zone_id'] = $this->request->post['zone_id'];
			$this->session->data['shipping_city'] = $this->request->post['city_id'];
...
public function zone() {
		...
		$zone_info = $this->model_localisation_zone->getZone($this->request->get['zone_id']);
			...
			$json = array(
				...
				'name'              => $zone_info['name'],
				//'iso_code_2'        => $zone_info['iso_code_2'],
				//'iso_code_3'        => $zone_info['iso_code_3'],
